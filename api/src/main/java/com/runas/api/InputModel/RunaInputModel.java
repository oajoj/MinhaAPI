package com.runas.api.InputModel;

public class RunaInputModel {
    private String nome;
    private String glifo;
    private String camada;
    private String calice;

    public RunaInputModel() {
    }

    public RunaInputModel(String nome, String glifo, String camada, String calice) {
        this.nome = nome;
        this.glifo = glifo;
        this.camada = camada;
        this.calice = calice;
